...
public class Player {
	...
	// Right now, there are no rules to moving pieces, so players can just move their pieces anywhere within the board.
	public void makeAMove(GameBoard board, int x1, int y1, int x2, int y2){
		...
		board.remove(x1, y1);
			...
			System.out.println("This piece doesn't belong to you or NULL");
		}
	}
}
